...
if (isset($_POST['submit'])) {
    ...
    if ($file_gambar['error'] == 0) {
        ...
        $destination = $_SERVER['DOCUMENT_ROOT'] . '/lab9_php_modular/assets/gambar/' . $filename;
    ...
    <div class="main-container">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <a href="../lab10_php_oop/index.php?page=user/list" class="btn btn-warning">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-section" style="grid-column: span 2;">
                            ...
                            <div class="current-image">
                                ...
                                <img src="../lab10_php_oop/assets/gambar/<?php echo $data['gambar'];?>" 
